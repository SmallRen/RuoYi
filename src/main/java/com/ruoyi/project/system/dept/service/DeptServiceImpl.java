...
public class DeptServiceImpl implements IDeptService {
    ...
    @Override
    public boolean checkDeptExistLaboratory(Long deptId) {
        List<Laboratory> laboratories = laboratoryMapper.checkDeptExistLaboratory(deptId);

        return laboratories.size() > 0 ? true : false;
    }
}
